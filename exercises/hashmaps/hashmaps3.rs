...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // first method
        // let team_1 = scores.entry(team_1_name).or_insert_with_key(|team| Team {
        //     name: team.to_string(),
        //     goals_scored: 0,
        //     goals_conceded: 0,
        // });
        ...
        // let team2 = scores.entry(team_2_name).or_insert_with_key(|team| Team {
        //     name: team.to_string(),
        //     goals_scored: 0,
        //     goals_conceded: 0,
        // });
